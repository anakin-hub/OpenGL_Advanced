...
void Shader::loadFile(std::string filename)
{
	std::string vertexFile, fragmentFile;
	vertexFile = "../Shader/" + filename + ".vs";
	fragmentFile = "../Shader/" + filename + ".fs";
...
void Shader::setMat4(const std::string& name, glm::mat4 transform)
{
